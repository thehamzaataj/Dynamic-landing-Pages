    ...
    <div className={`w-full mr-3  rounded-lg shadow  p-4 md:p-6 ${isDarkMode ? 'bg-[#1c1e21]':'bg-white'}`}>
      <div className="flex justify-between pb-4 mb-4  border-gray-200 dark:border-gray-700">
        <div className="flex items-center">
          ...
          <div>
            <h5 className={`leading-none text-2xl font-bold  pb-1 ${isDarkMode?'text-gray-300':'text-gray-900'}`}>3.4k</h5>
            <p className="text-sm font-normal text-gray-500 ">Leads generated per week</p>
          </div>
        </div>
        <div>
      ...
      <div className="grid grid-cols-2">
        <dl className="flex items-center">
          <dt className={`  text-sm font-normal me-1 ${isDarkMode?'text-gray-300':'text-gray-500'}`}>Money spent:</dt>
