...
const AdminSideBar = ({ active, isDarkMode }) => {
  ...
  return (
    <div
      className={`space-y-3 h-full overflow-y-auto shadow-lg ${
        isDarkMode ? "bg-[#1c1e21] text-gray-300" : "bg-white text-black"
      }`}
    >
      <div className="p-7 pb-2 flex items-center space-x-1">
        <img src={logo} alt="logox" className="w-50" />
      </div>
      ...
      <div className="p-3 space-y-1.5">
        ...
        <div className="flex">
          <Link
            ...
            className={`w-full flex items-center space-x-2 p-2.5 rounded transition-colors duration-200
              ${
                active === 1
                  ? "bg-[#696cff29] text-[#696cff]"
                  : "hover:bg-[#F2F3F4] hover:text-black"
              }`}
          >
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <IoIosArrowUp
              className={`transform transition-transform duration-300 text-[20px] ${
          ...
          {isSettingsOpen && (
            <div className="ml-4 mt-2 space-y-1">
              ...
              <div className="flex">
                ...
                >
                  <RiHome7Line className="text-[19px]" />
                  <h5 className="text-[15px]">Testimonial</h5>
                </Link>
              </div>
              ...
              <div className="flex">
                ...
                >
                  <RiHome7Line className="text-[19px]" />
                  <h5 className="text-[15px]">Pricing</h5>
                </Link>
              </div>
              {/* faqs */}
              <div className="flex">
